    ...
    return {
        ...
        "tools": [
            ...
            },
            {
                ...
                "method": "POST",
                "path": "/api/v1/decision/{token}/verify-recovery",
                "mcp_tool": "verify_evidence_recovery",
                "input": {"token": "asset symbol", "body": "prior refusal_recovery_v1 plan"},
                "output": "Observed recovery progress: debt change, recovered signals, resolved blockers, current actionability and safe next action.",
                "side_effects": "none",
            },
            {
